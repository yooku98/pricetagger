    ...
    <div className="flex flex-1 items-center justify-center p-8">
      <div className="w-full max-w-2xl">
        ...
        <Dropzone
          ...
          className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-neutral-700 bg-neutral-900 px-6 py-16 text-center transition-colors hover:border-neutral-500"
        >
